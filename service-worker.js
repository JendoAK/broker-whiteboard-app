const CACHE_NAME = "foodbrokerbase-trackerdate1";
const APP_SHELL = [
  ...
  "./market-events.js?v=20260914-printlogo1",
  ...
  "./team-work-view.js?v=20260909-activity1", "./app.js?v=20260914-trackerdate1",
