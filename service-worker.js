const CACHE_NAME = "foodbrokerbase-soupvendor1";
const APP_SHELL = [
  ...
  "./market-events.js?v=20260914-soupvendor1",
  ...
  "./team-work-view.js?v=20260909-activity1", "./app.js?v=20260914-soupvendor1",
